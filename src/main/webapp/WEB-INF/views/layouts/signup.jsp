...
<div class="well">    
    ...
    <c:if test="${userAdded == 'success'}">
      ...
      <form:form id="signup" class="form-horizontal" method="post" action="signup" commandName="register">
		<legend>${labelSignup}</legend>		
		...
		<div class="control-group">
	        <label class="control-label">${labelPassword}</label>
			<div class="controls">
			    <div class="input-prepend">
				<span class="add-on"><i class="icon-lock"></i></span>
					<form:input type="Password" id="passwd" class="input-xlarge" path="password" placeholder="${labelPassword}"/>					
				</div>
		...
		<label class="control-label" for="input01"></label>
	      <div class="controls">
	       <button type="submit" class="btn btn-success" rel="tooltip" title="Hi"><spring:message code="label.createMyAccount" /></button>
